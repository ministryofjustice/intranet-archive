...
[![Ministry of Justice Repository Compliance Badge](https://github-community.service.justice.gov.uk/repository-standards/api/intranet-archive/badge)](https://github-community.service.justice.gov.uk/repository-standards/intranet-archive)
...
> If a given agency's snapshot fails, it will be retried at the next scheduled time for that agency. Two consecutive failures will trigger an alert.
